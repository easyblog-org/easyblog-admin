<template>
  <el-dialog @close="close" v-model="dialogVisible" width="50%" draggable>
    <el-descriptions :title="title">
      ...
      <el-descriptions-item label="分组">{{ ruleForm.template_code }}</el-descriptions-item>
      <el-descriptions-item label="优先级">{{ ruleForm.template_code }}</el-descriptions-item>
      <el-descriptions-item label="消息参数配置">{{ ruleForm.configs }}</el-descriptions-item>
